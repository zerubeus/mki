        ...
        <header className="flex justify-between items-center mb-12 relative z-10 flex-col md:flex-row gap-8 md:gap-0 text-center md:text-right">
          <div className="order-2 md:order-1">
            <h1 
              ...
              style={{
                textShadow: '3px 3px 6px rgba(0, 0, 0, 0.4), 0 0 30px rgba(255, 215, 0, 0.3)',
        ...
        <main className="relative z-10">
          ...
          <section>
            ...
            >
              ...
              <h2 
                className="text-4xl font-bold mb-8 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 bg-clip-text text-transparent tracking-wide"
              >
